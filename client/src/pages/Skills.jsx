...
const skillsData = [
    {
        ...
        skillSummary: "In April 2024 I completed a professional Full Stack Web Development Boot Camp through the University of Utah. This taught me the inner workings of websites from front-end design and React, to optimizing SEO and website performance, to creating databases and more.",
        skills: [
            {
                name: "HTML & CSS",
            ...
            {
                name: "JavaScript",
                skillDescription: ["Full stack developer", "Vanilla, JQuery, Node, Express, Jest, MERN Stack, MVC paradigm, Git, Heroku and more"]
            },
            {
                name: "React",
            ...
            {
                name: "SQL",
                skillDescription: ["MySQL", "Sequelize"]
            },
            {
                name: "NoSQL",
                skillDescription: ["MongoDB", "Mongoose", "GraphQL"]
            }
        ],
    },
    {
    ...
    return (
        <>
            ...
            <div className="skills-page-container">
                ...
                <div>
                    <a href="https://docs.google.com/document/d/1dSNiWCcZeV5bt5KILhAf5K_CczSpAzO5CJ9Nf7dnM_U/edit?usp=sharing" target="_blank" rel="noopener noreferrer">
